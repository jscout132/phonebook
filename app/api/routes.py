...
# returns a single contact by id-- even though current_user_token isn't used
# in this function, it's still needed for some reason
...
#updating a contact
@api.route('/contacts/<id>', methods = ['GET','PUT'])
@token_required
